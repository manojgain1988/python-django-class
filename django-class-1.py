...
mkvirtualenv projectenv(env_name)/OR           [For virtual envirenment create]
python -m venv myenv(env_name)                 [For virtual envirenment create]
...
python -m venv myenv(env_name)/OR               [For create env] 
mkvirtualenv projectenv(env_name)               [For virtual envirenment create]
#myenv\Scripts\activate                         [For myenv(env_name) active] 
pip list                                        [for check which install]    
pip install django                              [For django install]
pip list (again)                                [for check properly django install]    
django-admin startproject first(project_name)   [For create project name]
